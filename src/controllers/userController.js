...
export const createRecord = async (req, res) => {
  ...
  req.body.installationDate = JSON.stringify(req.body.installationDate);
  req.body.fromDate = JSON.stringify(req.body.fromDate);
  req.body.toTheDate = JSON.stringify(req.body.toTheDate);
...
export const getRecordByHouseNumber = async (req, res)=>{
  ...
  try {
    ...
    const record = await User.findOne({ meterNumber}).sort('-created_at');
